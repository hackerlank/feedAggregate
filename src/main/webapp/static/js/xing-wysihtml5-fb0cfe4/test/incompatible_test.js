module("wysihtml5 - Incompatible", {
  setup: function() {
    ...
    wysihtml5.browser.supported = function() { return 0; };
...
asyncTest("Basic test", function() {
  ...
  editor.observe("load", function() {
    ...
    ok(!editor.isCompatible(), "isCompatible returns 0 when rich text editing is not correctly supported in the current browser");
    ...
    editor.observe("focus:composer", function() {
      ok(0, "Specific 'focus:composer' event fired, and that's wrong, there shouldn't be a composer element/view");
    });
